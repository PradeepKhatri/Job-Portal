        ...
        <div className='bg-white text-black rounded-lg w-ful'>
          <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20  mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
            ...
            <div className='flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center'>
              ...
              <p className='mt-1 text-gray-600'>Posted {JobData ? moment(JobData.date).fromNow() : ''}</p>
            </div>
          ...
          <div className='flex flex-col lg:flex-row justify-between items-start'>
            <div className='w-full lg:w-2/3'>
              ...
              {JobData && <div className='rich-text' dangerouslySetInnerHTML={{ __html: JobData.description }}></div>}
            ...
            <div className='w-full lg:w-1/3 mt-8 lg:mt-0 lg:ml-8 space-y-5'>
              <h2>More jobs from {JobData && JobData.companyId.name}</h2>
              {JobData && jobs.filter(job => job._id !== JobData._id && job.companyId._id === JobData.companyId._id)
                .filter(job => {
